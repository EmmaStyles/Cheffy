...
import com.infs3634.cheffy.dummy.DummyContent;
...
public class GoalListActivity extends AppCompatActivity {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final GoalListActivity mParentActivity;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(GoalDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(GoalDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(GoalListActivity parent,
